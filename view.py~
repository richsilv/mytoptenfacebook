...
def facebook_loggedin():
    ...
    return redirect(url_for('https://graph.facebook.com/oauth/access_token', client_id=FACEBOOK_APP_ID, redirect_uri=url_for('facebook_token_received', _external=True), 
